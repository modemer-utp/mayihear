"""
Test insights generation with the Teams transcript.
"""
import sys, os, json
...
PROMPT_TEMPLATE = open('mayihear-api/agents/prompts/generate_insights.prompt', encoding='utf-8').read()

prompt = PROMPT_TEMPLATE.replace('{transcript}', TRANSCRIPT).replace('{user_context}', 'Equipo de desarrollo evaluando opciones de transcripcion para reuniones institucionales en UTP.')
